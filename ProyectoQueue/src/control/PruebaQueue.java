...
public class PruebaQueue {
	 ...
	 * y las extracciones las hacemos por el frente de la lista.
	 *  También se las llama listas FIFO (First In First Out - primero en entrar primero en salir)

		Confeccionaremos un programa que permita utilizar la interfaz Queue 
		y mediante la clase LinkedList administre la lista tipo cola
	 * @param args
	 */
