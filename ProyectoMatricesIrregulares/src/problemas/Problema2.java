...
public class Problema2 {
	...
	/**
	 * Confeccionar una clase para administrar los días que han faltado 
	 * los 3 empleados de una empresa.
Definir un vector de 3 elementos de tipo String para cargar los nombres 
y una matriz irregular para cargar los días que han faltado cada empleado 
(cargar el número de día que faltó)
