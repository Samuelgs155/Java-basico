...
public class PruebaArrayList {
	 ...
	 * de la lista es inmediato mediante el método 'get', 
	 * en cambio la implementación del método 'get' 
	 ...
	 * la lista hasta llegar a la posición a buscar.
		...
		extracciones durante la ejecución del programa es más común utilizar 
